    ...
    <Layout title="동네생활" hasTabBar>
      <div className="divide-y-[2px] space-y-4">
        {[1, 2, 3, 4, 5, 6].map((_, i) => (
          <div
            key={i}
            className="flex flex-col items-start cursor-pointer pt-5"
          >
        ...
        <button className="fixed bottom-24 right-6 bg-orange-400 rounded-full p-4 text-white shadow-xl hover:bg-orange-500 hover:shadow-2xl cursor-pointer transition-colors">
          <svg
            className="w-6 h-6"
            fill="none"
            stroke="currentColor"
