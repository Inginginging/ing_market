...
const Home: NextPage = () => {
  return (
    <div className="bg-slate-400 py-20 px-10 xl:place-content-center grid gap-10 lg:grid-cols-2 xl:grid-cols-3 min-h-screen">
      <div className="bg-white rounded-3xl shadow-xl p-6 flex flex-col justify-around">
        <div>
          <span className="font-semibold text-2xl">Select Item</span>
          <div className="flex justify-between my-2 first:bg-red-100 even:bg-blue-100">
      ...
      <div className="bg-white rounded-3xl shadow-xl overflow-hidden group">
        <div className="bg-blue-500 text-white p-6 pb-14 xl:pb-40">
        ...
        <div className="bg-white rounded-3xl relative -top-6 p-6">
          <div className="flex justify-between items-end relative -top-16">
            ...
            <div className="rounded-full w-24 h-24 bg-red-400 group-hover:bg-blue-300 transition-colors" />
            <div className="flex flex-col items-center">
      ...
      <div className="bg-white rounded-3xl shadow-xl p-6 lg:col-span-2 xl:col-span-1">
