...
const Live: NextPage = () => {
  return (
    <div className="py-10  space-y-4 divide-y-2">
      ...
      <button className="fixed bottom-16 right-6 bg-orange-400 rounded-full p-4 text-white shadow-xl hover:bg-orange-500 hover:shadow-2xl cursor-pointer transition-colors border-transparent">
        <svg
          className="w-6 h-6"
          fill="none"
          stroke="currentColor"
