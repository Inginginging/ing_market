      ...
      <div className="mb-8">
        ...
        <div className="flex items-center space-x-3 py-3 border-b">
          ...
          <div>
            ...
            <p className="text-xs font-bold text-gray-500 cursor-pointer">
              View profile &rarr;
            </p>
          </div>
        </div>
        <div className="mt-5">
          <h1 className="text-3xl font-extrabold text-gray-900">Galaxy S50</h1>
          ...
          <div className="flex items-center justify-between space-x-2">
            <button className="flex-1 bg-orange-500 text-white py-3 px-4 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 hover:bg-orange-600 font-medium">
              Talk to seller
            </button>
